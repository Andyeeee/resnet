...
# ID number of GPU
_C.MODEL.DEVICE_ID = '0, 1, 2'
# Name of backbone
_C.MODEL.NAME = 'resnet50'
# _C.MODEL.NAME = 'swin_transformer'

# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = '/opt/data/private/yujian/convnext_small.pth'
# Use ImageNet pretrained model to initialize backbone or use self trained model to initialize the whole model
# Options: 'imagenet' , 'self' , 'finetune', 'original'
_C.MODEL.PRETRAIN_CHOICE = 'NO'
...
_C.DATASETS.ROOT_DIR = ('/opt/data/private/huawei/digix_data')
# 注意key value 中间不能有空格
