...
from src.utils.readData import read_dataset
...
logger = logging.getLogger("resnet_cifar10.train")
...
for epoch in tqdm(range(1,n_epochs+1)):
    ...
    time_per_batch = (end_time - start_time) / (batch_size)
    print("Epoch {} done. Time per batch: {:.3f}[s] Speed: {:.1f}[samples/s]"
                .format(epoch, time_per_batch, batch_size / time_per_batch))
    print('')
    print("Testing------")
    ...
    logger.info('Accuracy {}%'.format(100 * right_sample / total_sample))
